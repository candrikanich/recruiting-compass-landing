                    ...
                    <div className="absolute inset-0 flex items-center justify-center bg-green-900/80 backdrop-blur-sm">
                      <div className="text-center p-8">
                        ...
                        <p className="text-green-100">
                          Full-featured dashboard with recruiting timeline,
                          coach contacts, and progress tracking
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                    ...
                    <p className="text-green-100 text-sm">
                      See your entire recruiting journey at a glance with
                  ...
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                    ...
                    <p className="text-green-100 text-sm">
                      Track conversations with dozens of coaches across
                  ...
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                    ...
                    <p className="text-green-100 text-sm">
                      Easily upload highlight videos, transcripts, and share
                      them instantly with coaches
                    </p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                    ...
                    >
                      ...
                      <div className="absolute inset-0 flex items-center justify-center bg-green-900/80 backdrop-blur-sm">
                        <div className="text-center p-8">
                          ...
                          <p className="text-green-100 text-sm">
                            Stay connected on the go with push notifications and
                            instant updates
                          </p>
                        </div>
                      </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 w-full">
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                    ...
                    <p className="text-green-100 text-sm">
                      Check your recruiting status between classes, at practice,
                  ...
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                    ...
                    <p className="text-green-100 text-sm">
                      Never miss a deadline, coach response, or important
                  ...
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                    ...
                    <p className="text-green-100 text-sm">
                      Log conversations, update stats, and mark tasks complete
                      in seconds
                    </p>
                  </div>
                </div>
